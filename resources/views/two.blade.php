...
<main class="d-flex flex-nowrap">
    ...
    <div class="d-flex flex-column flex-shrink-0 p-3 bg-white scrollarea" style="width: 450px;">
        <a  class="d-flex align-items-center pb-3 mb-3 link-dark text-decoration-none border-bottom">

            <span class="fs-5 fw-semibold">MDEA</span>
        </a>
        <ul class="list-unstyled ps-0">
            @foreach($componentes as $componente)
                <li class="mb-1">
                    <button class="btn btn-toggle d-inline-flex align-items-center rounded border-0 collapsed fw-bold"

                            data-bs-toggle="collapse" aria-expanded="false" data-bs-target="#comp_{{$componente->id_comp}}">
                        {{$componente->nombre}}
                    </button>
            <li class="border-top my-3"></li>
                    <div class="collapse" id="comp_{{$componente->id_comp}}">
                        ...
                        <ul class="list-unstyled ps-0">
                            @foreach($subComponentes as $subComponente)
                                @if($subComponente->id_comp === $componente->id_comp)
                                    <li class="mb-1">
                                        <button
                                            class="btn btn-toggle d-inline-flex align-items-center rounded border-0 collapsed p-3 font-italic"
                            ...
                            <li class="border-top my-3"></li>
                                        <div class="collapse" id="sub_{{$subComponente->id}}">
                                            <ul class="list-unstyled ps-0">
                                                @foreach($topicos as $topico)
                                                @if($topico->id_sub === $subComponente->id)
                                                <li class="mb-1">
                                                    <button
                                                        class="btn btn-toggle d-inline-flex align-items-center rounded border-0 collapsed p-6"
                                                ...
                                                <li class="border-top my-3"></li>
                                                    <div class="collapse" id="top_{{$topico->id}}">
                                                        <ul class="btn-toggle-nav list-unstyled fw-normal pb-1 small">
                                                            @foreach($variables as $variable)
                                                            @if($variable->id_top === $topico->id)
                                                            <li><a href="#" class="text-decoration-underline link-dark d-inline-flex text-decoration-none rounded">{{$variable->nombre}}</a>
                                                            </li>
                                                            <li class="border-top my-3"></li>
                                                            @endif
                                                            @endforeach
